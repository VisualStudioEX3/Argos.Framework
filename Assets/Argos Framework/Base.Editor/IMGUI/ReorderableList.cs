...
{
    /// <summary>
    /// Basic ReorderableList object with default/standard behaviour.
    /// </summary>
    /// <remarks>A basic implementation of Unity ReorderableList object with default behaviour implemented: optional header caption, optional add and remove buttons, and default render serialized property element behaviour (draws the all child elements).</remarks>
    public sealed class ReorderableList : ReorderableListBase, IDisposable
    {
