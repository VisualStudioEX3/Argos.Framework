...
/// </summary>
namespace Argos.Framework.EditorExtensions
{
    public class CreateCone : ScriptableWizard
    {
        ...
        void OnWizardCreate()
        {
            ...
            else if (System.IO.Path.GetExtension(destPath) != "")
            {
                destPath = destPath.Replace(System.IO.Path.GetFileName(AssetDatabase.GetAssetPath(Selection.activeObject)), "");
            }

            //string meshPrefabPath = "Assets/Editor/" + meshName + ".asset";
            string meshPrefabPath = destPath + "/" + meshName + ".asset";
